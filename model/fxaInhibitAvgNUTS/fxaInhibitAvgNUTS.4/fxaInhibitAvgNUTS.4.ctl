$PROB fxaInhibitAvgNUTS.4 example, Emax model
...
$THETA
2.25839767168599      ; EMAX = 100 * EXPIT(THETA(1))
5.03599195841776  ; EC50 = EXP(THETA(2))
0.232728325311984    ; GAMMA = EXP(THETA(3))
1.87042840850047   ; SD = (THETA(4)) 
(1 FIX)
...
OVARF= 1
NUTS_DELTA= 0.8
NBURN = 500 NITER = 500 SEED = 1184
PRINT = 100 NOABORT FILE = /dev/null
$TABLE ID EVID CONC DV PRED
NOPRINT ONEHEADER FILE=./fxaInhibitAvgNUTS.4.tab
$TABLE ID EMAX EC50 GAMMA SD
NOPRINT ONEHEADER FILE=./fxaInhibitAvgNUTS.4par.tab
