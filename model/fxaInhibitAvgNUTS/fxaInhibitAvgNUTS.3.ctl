$PROB fxaInhibitAvgNUTS.3 example, Emax model
...
$THETA
2.04046221374932      ; EMAX = 100 * EXPIT(THETA(1))
4.90552301851808  ; EC50 = EXP(THETA(2))
-0.160700284041577    ; GAMMA = EXP(THETA(3))
2.14817692445583   ; SD = (THETA(4)) 
(1 FIX)
...
OVARF= 1
NUTS_DELTA= 0.8
NBURN = 500 NITER = 500 SEED = 8663
PRINT = 100 NOABORT FILE = /dev/null
$TABLE ID EVID CONC DV PRED
NOPRINT ONEHEADER FILE=./fxaInhibitAvgNUTS.3.tab
$TABLE ID EMAX EC50 GAMMA SD
NOPRINT ONEHEADER FILE=./fxaInhibitAvgNUTS.3par.tab
