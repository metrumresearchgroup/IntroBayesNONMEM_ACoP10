$SIZES LVR=50
$PROBLEM RUN friberg3.4 neutropenia PKPD example with Friberg-Karlsson PK-PD
...
$THETA
2.29293650954706      ; Log CL = THETA(1)
2.78187002197878      ; Log Q = THETA(2)
4.10653043167607    ; Log V1 = THETA(3)
5.79441188940434    ; Log V2= THETA(4) 
0.758743417852145    ; Log Ka = THETA(5) 
4.78975235013628    ; Log MTT = THETA(6) 
1.7904012807499    ; Log CIRC0 = THETA(7) 
-8.82748705123275    ; Log ALPHA = THETA(8) 
-1.91147638613364    ; Log GAMMA = THETA(9) 
-1.96694893289804    ; Log PK Add Error = THETA(10) 
-1.53523045323129    ; Log PD Add Error = THETA(11) 
(1 FIX)
