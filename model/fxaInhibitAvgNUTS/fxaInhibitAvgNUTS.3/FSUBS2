      ...
      REAL(KIND=DPSIZE), POINTER ::nThin,MU_1,MU_2,MU_3,MU_4,LGT_EMAX
      REAL(KIND=DPSIZE), POINTER ::EMAX,EC50,GAMMA,SD,RESP,Y
      REAL(KIND=DPSIZE), POINTER ::FIRST_WRITE_PAR,A000035,A000041
      REAL(KIND=DPSIZE), POINTER ::A000070,A000114,A000112,A000113
      REAL(KIND=DPSIZE), POINTER ::A000073,A000131,A000132,A000072
      REAL(KIND=DPSIZE), POINTER ::A000128,A000137,A000142,A000144
      REAL(KIND=DPSIZE), POINTER ::A000143,A000135,A000140,A000139
      REAL(KIND=DPSIZE), POINTER ::A000136,A000141,A000138,A000145
      REAL(KIND=DPSIZE), POINTER ::C000031,A000146
      CONTAINS
      SUBROUTINE ASSOCNMPRD4
      COM=>VRBL
      nThin=>COM(000001);MU_1=>COM(000002);MU_2=>COM(000003)
      MU_3=>COM(000004);MU_4=>COM(000005);LGT_EMAX=>COM(000006)
      EMAX=>COM(000007);EC50=>COM(000008);GAMMA=>COM(000009)
      SD=>COM(000010);RESP=>COM(000011);Y=>COM(000012)
      FIRST_WRITE_PAR=>COM(000013);A000035=>COM(000014)
      A000041=>COM(000015);A000070=>COM(000016);A000114=>COM(000017)
      A000112=>COM(000018);A000113=>COM(000019);A000073=>COM(000020)
      A000131=>COM(000021);A000132=>COM(000022);A000072=>COM(000023)
      A000128=>COM(000024);A000137=>COM(000025);A000142=>COM(000026)
      A000144=>COM(000027);A000143=>COM(000028);A000135=>COM(000029)
      A000140=>COM(000030);A000139=>COM(000031);A000136=>COM(000032)
      A000141=>COM(000033);A000138=>COM(000034);A000145=>COM(000035)
      C000031=>COM(000036);A000146=>COM(000037)
...
!                      A000145 = 2ND DERIV OF F W.R.T. ETA(004), ETA(004)
      ...
      NAME_FSIZES(12)='MAXIDS'; F_SIZES(12)=80
      ...
      NAME_FSIZES(42)='PDT'; F_SIZES(42)=5
