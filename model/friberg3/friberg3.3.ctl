$SIZES LVR=50
$PROBLEM RUN friberg3.3 neutropenia PKPD example with Friberg-Karlsson PK-PD
...
$THETA
1.85513322357548      ; Log CL = THETA(1)
2.44937306056185      ; Log Q = THETA(2)
3.23209104627349    ; Log V1 = THETA(3)
4.27872628521996    ; Log V2= THETA(4) 
0.480316311357363    ; Log Ka = THETA(5) 
4.84344344816967    ; Log MTT = THETA(6) 
1.86638760375415    ; Log CIRC0 = THETA(7) 
-9.26072372902051    ; Log ALPHA = THETA(8) 
-1.9187980528032    ; Log GAMMA = THETA(9) 
-1.21818684046465    ; Log PK Add Error = THETA(10) 
-1.27025282894356    ; Log PD Add Error = THETA(11) 
(1 FIX)
