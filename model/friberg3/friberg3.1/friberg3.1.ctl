$SIZES LVR=50
$PROBLEM RUN friberg3.1 neutropenia PKPD example with Friberg-Karlsson PK-PD
...
$THETA
1.96962961637382      ; Log CL = THETA(1)
2.6218130736915      ; Log Q = THETA(2)
3.17188380352578    ; Log V1 = THETA(3)
5.06136560828594    ; Log V2= THETA(4) 
1.42390718034279    ; Log Ka = THETA(5) 
4.80105775620579    ; Log MTT = THETA(6) 
1.51419922629621    ; Log CIRC0 = THETA(7) 
-9.70480223668207    ; Log ALPHA = THETA(8) 
-1.9069946979951    ; Log GAMMA = THETA(9) 
-1.38567381735599    ; Log PK Add Error = THETA(10) 
-1.74399509515884    ; Log PD Add Error = THETA(11) 
(1 FIX)
...
0.0118792005476596
0.138905086301638
0.000304426979397928
0.000304426979397928
0.000304426979397928
0.000304426979397928
0.000304426979397928
0.222738452676238
0.000856221985323029
0.000856221985323029
0.000856221985323029
0.000856221985323029
0.000856221985323029
